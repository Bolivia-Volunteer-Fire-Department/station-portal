...
This card controls push notifications to your devices. There are up to four switches, and which ones you see depends on your role:

| Switch | What it tells you |
|---|---|
| **New shift requests** | Somebody has offered to fill a shift. *Only shown if your role can approve shift requests* |
| **My shift request approved** | An offer **you** made was approved |
