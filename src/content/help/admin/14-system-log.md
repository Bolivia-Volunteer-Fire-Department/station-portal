...
A read-only record of what has happened in the portal: who signed in (and who failed to), what was changed and by whom, and which notifications were sent. Requires **View the system log**.
